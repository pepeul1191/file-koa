...
import { randomFileName, sanitizeFileName } from '../configs/helpers.js';
...
export const uploadPublic = async (ctx) => {
  try {
    let { folder, autogenerated = true } = ctx.request.body; // autogenerated por defecto true
    ...
    // Determinar el nombre del archivo según autogenerated
    let newFileName;
    let originalFileName = null;
    
    if (autogenerated === true || autogenerated === 'true') {
      // Usar nombre autogenerado
      newFileName = `${randomFileName(30)}${ext}`;
    } else {
      // Usar nombre original, sanitizado para evitar problemas
      ...
      if (fs.existsSync(finalPath)) {
        ...
        newFileName = `${sanitizedName}_${timestamp}${ext}`;
      }
    }
    ...
    ctx.body = {
      ...
      data: {
        ...
        autogenerated: autogenerated === true || autogenerated === 'true',
        path: relativePath,
        fullPath: finalPath
      },
      error: null
